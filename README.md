...
`PhoenixSwagger` provides a mix compiler and mix task `phx.swagger.generate` for the the swagger-ui `json`
...
Add `:phoenix_swagger` to the list of compilers to autmatically update the swagger files each time the app is compiled:
